...
# Calculate Lungcap mean by Gengder using filtering just to demonstrate that I know how to filter
...
# Boxplot LungCap by Age
boxplot(LungCap ~ Age, main="Lungcap distribution by Age using boxplot")
